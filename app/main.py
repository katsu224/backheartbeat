...
from app.api.v1 import auth, button, couple, gallery, games, media, scheduled_signals, signal, trigger, watch, websocket
...
app.include_router(scheduled_signals.router, prefix="/api/v1")
